      ...
      <div className="relative w-full h-[65vh] overflow-hidden">
        ...
        <div className=" pt-20 absolute inset-0 flex flex-col items-center justify-center text-center text-white px-5">
          ...
          <p className="max-w-2xl sm:text-xl text-[12px] leading-relaxed font-bold">
           At CakeZone, we’re not just about baking; we’re about crafting moments of pure joy and indulgence. Our mission has been to delight the people of Indore with exceptional baked goods made with passion and creativity.
          </p>
        </div>
      </div>

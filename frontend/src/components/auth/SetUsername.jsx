...
const SetUsername = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await api.post(`/api/auth/set-username`, payload);
      ...
      >
        ...
        <div className="mb-6">
          ...
          <input
            ...
            maxLength={20}
            required
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#e11d48] focus:border-[#e11d48] focus:outline-none transition-colors"

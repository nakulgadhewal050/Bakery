...
const VerifyOTP = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fff0f3] px-4">
      <div className="bg-white shadow-xl rounded-xl p-8 w-full max-w-md border border-gray-200">
        <h2 className="text-3xl font-bold text-center text-[#e11d48] mb-2">
          Verify OTP
        </h2>
          ...
          <div className="flex justify-center gap-3 mb-6">
            {otp.map((digit, index) => (
              <input
                ...
                className="w-12 h-14 text-center text-2xl font-bold border-2 border-gray-300 rounded-lg focus:border-[#e11d48] focus:ring-2 focus:ring-[#e11d48] outline-none transition-all"
              />
            ))}
          </div>
          ...
          <div className="text-center mt-4">
            {timer > 0 ? (
              <p className="text-gray-600">
                Resend OTP in{" "}
                <span className="font-bold text-[#e11d48]">{timer}s</span>
              </p>
            ) : (
              <button
                type="button"
                ...
                disabled={!canResend}
                className="text-[#e11d48] font-semibold hover:underline disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Resend OTP
              </button>
            )}
        ...
        <div className="text-center mt-4">
          <button
            ...
            className="text-gray-600 hover:text-[#e11d48] font-medium"
          >

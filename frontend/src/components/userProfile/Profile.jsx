      ...
      <div className="mx-auto w-full max-w-7xl mt-15">
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          <aside className="w-full md:w-64 lg:w-72 h-[300px]">
            <div className="sticky top-10 flex flex-col justify-between rounded-xl bg-white p-4 shadow-sm min-h-[70vh]">
              {/* USER MINI HEADER */}
          ...
          <section className="flex-1 flex flex-col gap-8">
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm">
              ...
              <div className="flex justify-end mt-6">
                ...
                >
                  <button
                    className="px-6 py-2 rounded-lg text-white font-semibold bg-red-600 hover:bg-red-700 transition flex items-center gap-2"
                    type="button"
                  >
...
<div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  <div className="bg-pink-50 p-5 rounded-xl">
    <p className="text-sm text-pink-600 font-medium">Sweet Tooth Level 🍰</p>

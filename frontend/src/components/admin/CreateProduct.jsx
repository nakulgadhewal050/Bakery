        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full border border-gray-700 p-3 rounded focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
              required
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full border border-gray-300 p-3 rounded focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
              rows="3"
            />
          </div>
            ...
            <div className="flex gap-2">
              <div className="relative w-[40%]">
                <select
                  ...
                  onChange={handleChange}
                  value={form.category}
                  className="border border-gray-300 p-3 rounded w-full focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
                  required
                >
              ...
              <input
                ...
                className="border border-gray-300 p-3 rounded w-[60%] focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
              />
            </div>
          </div>
              ...
              <div className="flex gap-2">
                <div className="relative w-[40%]">
                  <select
                    ...
                    onChange={handleChange}
                    value={form.flavour}
                    className="border border-gray-300 p-2 rounded w-full focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
                  >
                ...
                <input
                  ...
                  className="border border-gray-300 p-2 rounded w-[60%] focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
                />
              </div>
            </div>
          ...
          <div className="flex gap-3 items-center p-3 bg-gray-50 rounded">
            <input
              ...
              onChange={handleChange}
              className="w-5 h-5 text-[#e11d48] rounded focus:ring-[#be123c]"
            />
            <label
              htmlFor="isFeatured"
          ...
          <div className="space-y-3">
            ...
            {/* File input */}
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#be123c] transition cursor-pointer group">
              <input
                type="file"
                id="imageUpload"
                multiple
              ...
              <label htmlFor="imageUpload" className="cursor-pointer">
                <div className="flex flex-col items-center gap-2">
                  <svg
                    className="w-12 h-12 text-gray-400 group-hover:text-[#be123c]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >

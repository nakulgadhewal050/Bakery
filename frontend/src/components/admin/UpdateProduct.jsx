    ...
    return (
      <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#be123c]"></div>
          <p className="mt-4 text-lg text-[#be123c]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <select
                ...
                onChange={handleChange}
                value={form.category}
                className="border border-gray-300 p-3 rounded w-[40%] focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
                required
                disabled={submitting}
              >
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  onChange={handleChange}
                  value={form.flavour}
                  className="border border-gray-300 p-2 rounded w-[40%] focus:ring-2 focus:ring-[#be123c] focus:border-transparent"
                  disabled={submitting}
                >
          ...
          <div className="flex gap-3 items-center p-3 bg-gray-50 rounded">
            <input
              ...
              onChange={handleChange}
              className="w-5 h-5 text- [#be123c] rounded"
              disabled={submitting}
            />
            <label
              htmlFor="isFeatured"
          ...
          <div className="pt-4 flex gap-3">
            ...
            {/* <button
              ...
              onClick={onClose}
              disabled={submitting}
              className={`flex-1 py-3 bg-white  text-black font-semibold rounded transition ${
                submitting
